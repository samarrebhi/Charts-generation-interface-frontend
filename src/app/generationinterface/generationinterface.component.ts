...
@Component({
  selector: 'app-generationinterface',
  standalone: true,
  ...
  templateUrl: './generationinterface.component.html',
  styleUrl: './generationinterface.component.scss'
})
export class GenerationinterfaceComponent  implements OnInit {
  ...
  constructor(private s: PersonnechartsService, private fb: FormBuilder,private dialog: MatDialog) {
  ...
  onChartTypeChange(event: any): void {
    ...
    console.log('Selected chart type:', event.value);  // Should log the selected value
  }
